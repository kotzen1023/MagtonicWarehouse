...
class IssuanceLookupItemAdapter (context: Context?, resource: Int, objects: ArrayList<IssuanceLookupItem>) :
    ArrayAdapter<IssuanceLookupItem>(context as Context, resource, objects) {

    private val layoutResourceId: Int = resource

    private var inflater : LayoutInflater = context?.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
    private val items: ArrayList<IssuanceLookupItem> = objects
    ...
    override fun getItem(position: Int): IssuanceLookupItem? {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val IssuanceLookupItem = items[position]
        ...
        holder.itemHeader.text = IssuanceLookupItem.getData2()
        holder.itemContent.text = IssuanceLookupItem.getData6()
    ...
    class ViewHolder (view: View) {
        var itemHeader: TextView = view.findViewById(R.id.issuanceLookupItemHeader)
        var itemContent: TextView = view.findViewById(R.id.issuanceLookupItemHContent)
